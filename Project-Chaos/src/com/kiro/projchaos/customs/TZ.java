...
public class TZ extends EntityZombie{
	...
	public TZ(org.bukkit.World world) {
		...
		this.goalSelector.a(2, new PathfinderGoalMeleeAttack(this, EntitySnowman.class, 1.0D, true));
		this.goalSelector.a(4, new PathfinderGoalMeleeAttack(this, EntityOcelot.class, 1.0D, true));
	    this.goalSelector.a(5, new PathfinderGoalMoveTowardsRestriction(this, 1.0D));
	    this.goalSelector.a(6, new PathfinderGoalMoveThroughVillage(this, 1.0D, false));
	    this.goalSelector.a(7, new PathfinderGoalRandomStroll(this, 1.0D));
	    this.goalSelector.a(8, new PathfinderGoalLookAtPlayer(this, EntitySnowman.class, 8.0F));
	    this.goalSelector.a(8, new PathfinderGoalLookAtPlayer(this, EntityOcelot.class, 8.0F));
	    this.goalSelector.a(8, new PathfinderGoalRandomLookaround(this));
	    this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, true));
	    this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntitySnowman.class, true));
